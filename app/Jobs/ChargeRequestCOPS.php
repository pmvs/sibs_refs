...
class ChargeRequestCOPS implements ShouldQueue
{
    ...
    {
        \Log::channel($this->logchannel)->info('JOB ChargeRequestCOPS HANDLE ' . $this->counter .  ' ' . $this->iban);
    ...
    public function failed()
    {
        ...
        $datainfo = 'ChargeRequestCOPS JOB failed';
