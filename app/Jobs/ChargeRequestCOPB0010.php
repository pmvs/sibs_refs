...
class ChargeRequestCOPB0010 implements ShouldQueue
{
    ...
    {
        \Log::channel($this->logchannel)->info('JOB ChargeRequestCOPB0010 HANDLE ' . $this->counter . ' ' .  $this->psp_destination);

        $i = 1;
        while ( $i <= 2) {

            \Log::channel($this->logchannel)->info('JOB ChargeRequestCOPB0010 Request ' . $i);
    ...
    public function failed()
    {
        ...
        $datainfo = 'ChargeRequestCOPB0010 JOB failed'. $this->counter . ' ' .  $this->psp_destination;
