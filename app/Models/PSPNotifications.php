...
class PSPNotifications extends Model
{

    protected $connection = "mysql";
    protected $logchannel = 'proxylookup';
    protected $isConnProduction = false;
    protected $table = "psp_notifications";
    ...
    */
    public function __construct() 
    {
        ...
        \Log::channel($this->logchannel)->info('__construct PSPCOPRequest');
    ...
    public function __construct_1($logchannel) 
    {
        ...
        \Log::channel($this->logchannel)->info('__construct_1 PSPCOPRequest');
    }
    ...
    public function __construct_2($logchannel, $isConnProduction ) 
    {
        ...
        \Log::channel($this->logchannel)->info('__construct_2 PSPCOPRequest');
    }
