...
class PlNotificacaoRemoved extends Model
{
    protected $connection = "mysql";
    protected $logchannel = 'pl-removed';
    protected $isConnProduction = false;
    protected $table = "psp_notification_removed";
    ...
    */
    public function __construct() 
    {
        ...
        \Log::channel($this->logchannel)->info('__construct PlNotificacaoRemoved');
    ...
    public function __construct_1($logchannel) 
    {
        ...
        \Log::channel($this->logchannel)->info('__construct_1 PlNotificacaoRemoved');
    }
    ...
    public function __construct_2($logchannel, $isConnProduction ) 
    {
        ...
        \Log::channel($this->logchannel)->info('__construct_2 PlNotificacaoRemoved');
    }
